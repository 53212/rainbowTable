...
namespace rainbow
{
    ...
    /**
     * @brief nbPasswordsPerThread
     * This is the number of hash that a single thread will uncypher
     */
    const int nbPasswordsPerThread = 10;

    /**
     * @brief nbPasswordsInEveryLineForUncyphering
     * This is the number hash's function and reduce's function used for each line in rainbow table
     */
    ...
    /**
     * @brief findPswS
     * This function will use the fonction findPsw but with multiple threads
     * @param hashToUncypher
     * the hash to uncypher but will be the uncyphered a the end
     * @return the corretc password found
     */
